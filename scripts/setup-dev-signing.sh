#!/bin/zsh
#
# Create a local self-signed code signing identity for Agent Island
...
IDENTITY_NAME="Agent Island Local"
...
echo "you give Agent Island will persist across rebuilds."
