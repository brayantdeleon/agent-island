#!/bin/zsh
#
# Create a local self-signed code signing identity for Agent-Island dev
...
IDENTITY_NAME="Agent-Island Dev Local"
...
echo "you give Agent-Island Dev will persist across rebuilds."
