...
### Delete entirely
- `Sources/AgentIslandApp/TerminalSessionAttachmentProbe.swift` (1170 lines)

### New file
- `Sources/AgentIslandApp/TerminalJumpTargetResolver.swift` (~250 lines) — AppleScript snapshot matching for jump target precision only

### Simplify or delete
- `Sources/AgentIslandCore/ClaudeSessionRegistry.swift` (159 lines) — delete or gut to ~30 lines for pending-interaction-only persistence

### Modify: `Sources/AgentIslandCore/AgentSession.swift`
...
### Modify: `Sources/AgentIslandCore/SessionState.swift`
...
### Modify: `Sources/AgentIslandApp/AppModel.swift` (~450 lines removed)
...
### Modify: `Sources/AgentIslandCore/BridgeServer.swift`
