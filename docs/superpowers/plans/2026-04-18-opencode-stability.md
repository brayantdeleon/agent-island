...
**Files:**
- Create: `Sources/AgentIslandCore/OpenCodeSessionRegistry.swift`
...
```bash
git add Sources/AgentIslandCore/OpenCodeSessionRegistry.swift
...
**Files:**
- Modify: `Sources/AgentIslandApp/SessionDiscoveryCoordinator.swift`
...
```bash
git add Sources/AgentIslandApp/SessionDiscoveryCoordinator.swift
...
**Files:**
- Modify: `Sources/AgentIslandApp/AppModel.swift`
- Modify: `Sources/AgentIslandApp/ProcessMonitoringCoordinator.swift`
...
```bash
git add Sources/AgentIslandApp/AppModel.swift Sources/AgentIslandApp/ProcessMonitoringCoordinator.swift
...
2. Check `~/Library/Application Support/agent-island/opencode-session-registry.json`.
3. Restart Agent-Island.
