...
public enum HookSkipConfiguration {
    /// Preferred Agent-Island environment key for disabling hooks in this process.
    /// Agent-Island 推荐使用的当前进程 hook 跳过开关。
    public static let agentIslandSkipKey = "AGENT_ISLAND_SKIP_HOOKS"
    ...
    public static func shouldSkipHooks(environment: [String: String]) -> Bool {
        isTruthy(environment[agentIslandSkipKey])
