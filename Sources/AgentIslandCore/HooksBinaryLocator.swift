...
public enum ManagedHooksBinary {
    public static let binaryName = "AgentIslandHooks"
...
public enum HooksBinaryLocator {
    public static func locate(
        ...
        if let explicitPath = environment["AGENT_ISLAND_HOOKS_BINARY"] ?? environment["VIBE_ISLAND_HOOKS_BINARY"],
        ...
        let candidates = [
            executableDirectory?.appendingPathComponent("AgentIslandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("AgentIslandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("Helpers/AgentIslandHooks"),
            ...
            #endif
            return [
                currentDirectory.appendingPathComponent(".build/\(archTriple)/release/AgentIslandHooks"),
                currentDirectory.appendingPathComponent(".build/release/AgentIslandHooks"),
                ...
                currentDirectory.appendingPathComponent(".build/\(archTriple)/debug/AgentIslandHooks"),
                currentDirectory.appendingPathComponent(".build/debug/AgentIslandHooks"),
