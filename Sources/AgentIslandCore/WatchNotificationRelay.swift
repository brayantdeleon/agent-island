...
public final class WatchNotificationRelay: @unchecked Sendable {
    private static let logger = Logger(subsystem: "app.agentisland", category: "WatchNotificationRelay")
    ...
    private let queue = DispatchQueue(label: "app.agentisland.watch.relay")
