...
private struct SetupCommand {
    ...
    private func install() throws {
        ...
        print("Installed Agent-Island Codex hooks.")
    ...
    private func uninstall() throws {
        ...
        print("Removed Agent-Island Codex hooks.")
        print("Codex dir: \(status.codexDirectory.path)")
    ...
    private func installClaude() throws {
        ...
        print("Installed Agent-Island Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        print("Hooks binary: \(hooksBinary.path)")
        if status.hasClaudeIslandHooks {
            print("Note: claude-island hooks are still present alongside Agent-Island hooks.")
        }
    }
    ...
    private func uninstallClaude() throws {
        ...
        print("Removed Agent-Island Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        if status.hasClaudeIslandHooks {
    ...
    private func installKimi() throws {
        ...
        print("Installed Agent-Island Kimi hooks.")
    ...
    private func uninstallKimi() throws {
        ...
        print("Removed Agent-Island Kimi hooks.")
        print("Kimi dir: \(status.kimiDirectory.path)")
...
private enum SetupError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usage:
            """
            Usage:
              swift run AgentIslandSetup install [--hooks-binary /abs/path/to/AgentIslandHooks] [--codex-dir /abs/path/to/.codex]
              swift run AgentIslandSetup uninstall [--codex-dir /abs/path/to/.codex]
              swift run AgentIslandSetup status [--hooks-binary /abs/path/to/AgentIslandHooks] [--codex-dir /abs/path/to/.codex]
              swift run AgentIslandSetup installClaude [--hooks-binary /abs/path/to/AgentIslandHooks] [--claude-dir /abs/path/to/.claude]
              swift run AgentIslandSetup uninstallClaude [--claude-dir /abs/path/to/.claude]
              swift run AgentIslandSetup statusClaude [--hooks-binary /abs/path/to/AgentIslandHooks] [--claude-dir /abs/path/to/.claude]
              swift run AgentIslandSetup installKimi [--hooks-binary /abs/path/to/AgentIslandHooks] [--kimi-dir /abs/path/to/.kimi]
              swift run AgentIslandSetup uninstallKimi [--kimi-dir /abs/path/to/.kimi]
              swift run AgentIslandSetup statusKimi [--hooks-binary /abs/path/to/AgentIslandHooks] [--kimi-dir /abs/path/to/.kimi]
            """
