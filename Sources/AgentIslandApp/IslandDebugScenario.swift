    ...
    func snapshot(at now: Date = .now) -> IslandDebugSnapshot {
        ...
        case .approvalCard:
            ...
            return IslandDebugSnapshot(
                ...
                islandSurface: .notification(sessionID: session.id),
    ...
    static func runningSession(now: Date) -> AgentSession {
        AgentSession(
            ...
            codexMetadata: CodexSessionMetadata(
                ...
                currentCommandPreview: "sed -n '1,260p' Sources/AgentIslandApp/Views/SettingsView.swift"
            )
        )
    }
    ...
    static func approvalSession(now: Date) -> AgentSession {
        AgentSession(
            ...
            permissionRequest: PermissionRequest(
                ...
                summary: "Allow exec_command to rewrite SettingsView.swift?",
                affectedPath: "Sources/AgentIslandApp/Views/SettingsView.swift",
    ...
    static func longCompletionSession(now: Date) -> AgentSession {
        AgentSession(
            ...
            codexMetadata: CodexSessionMetadata(
                ...
                lastAssistantMessage: """
[README.md](/Users/wangruobing/Personal/agent-island/README.md) 的现有改动已经单独提交了，commit 是 `f196316`，message 是 `docs: update readme tagline`。
