...
final class ConnectionManager: ObservableObject {
    private static let logger = Logger(subsystem: "app.agentisland.mobile", category: "ConnectionManager")
    ...
    @Published var notifyPermissions: Bool {
        didSet { UserDefaults.standard.set(notifyPermissions, forKey: "agentisland.notify.permissions") }
    }
    @Published var notifyQuestions: Bool {
        didSet { UserDefaults.standard.set(notifyQuestions, forKey: "agentisland.notify.questions") }
    }
    @Published var notifyCompletions: Bool {
        didSet { UserDefaults.standard.set(notifyCompletions, forKey: "agentisland.notify.completions") }
    }
    @Published var silentCompletions: Bool {
        didSet { UserDefaults.standard.set(silentCompletions, forKey: "agentisland.notify.silentCompletions") }
    }
    ...
    private var savedToken: String? {
        get { UserDefaults.standard.string(forKey: "agentisland.token") }
        set { UserDefaults.standard.set(newValue, forKey: "agentisland.token") }
    }
    private var savedMacName: String? {
        get { UserDefaults.standard.string(forKey: "agentisland.macName") }
        set { UserDefaults.standard.set(newValue, forKey: "agentisland.macName") }
    }
    var pairedAt: Date? {
        get {
            let interval = UserDefaults.standard.double(forKey: "agentisland.pairedAt")
            return interval > 0 ? Date(timeIntervalSince1970: interval) : nil
        }
        set {
            if let date = newValue {
                UserDefaults.standard.set(date.timeIntervalSince1970, forKey: "agentisland.pairedAt")
            } else {
                UserDefaults.standard.removeObject(forKey: "agentisland.pairedAt")
            }
        }
    }
    ...
    init() {
        ...
        self.notifyPermissions = defaults.object(forKey: "agentisland.notify.permissions") as? Bool ?? true
        self.notifyQuestions = defaults.object(forKey: "agentisland.notify.questions") as? Bool ?? true
        self.notifyCompletions = defaults.object(forKey: "agentisland.notify.completions") as? Bool ?? true
        self.silentCompletions = defaults.object(forKey: "agentisland.notify.silentCompletions") as? Bool ?? false
    ...
    private func startNetworkMonitor() {
        ...
        monitor.start(queue: DispatchQueue(label: "app.agentisland.mobile.network"))
