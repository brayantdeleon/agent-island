...
/// Discovered Mac running Agent-Island.
...
/// Uses NWBrowser to discover macOS instances advertising `_agentisland._tcp`.
@MainActor
final class BonjourDiscovery: ObservableObject {
    private static let logger = Logger(subsystem: "app.agentisland.mobile", category: "BonjourDiscovery")
