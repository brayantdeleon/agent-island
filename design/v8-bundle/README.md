...
```
open "design/v8-bundle/project/Agent-Island - v8 (final) v2.html"
```
...
v8-bundle/
├── project/
│   ├── Agent-Island - v8 (final) v2.html    ← entry
...
`v8_core.jsx` mirrors `Sources/AgentIslandCore/AgentSession.swift`:
