  ...
  return (
    <div className="app v3">
      <header className="topbar">
        <div className="brand"><span className="dot-v3" /><span>Agent-Island · Logo v3</span></div>
          ...
          <div className="finder-plate">
            {variants.map(v => (
              <div key={v.id} className="finder-item">
                ...
                <div className="finder-name">Agent-Island<br /><span className="mono">{v.id}</span></div>
              </div>
            ))}
          </div>
        </section>
