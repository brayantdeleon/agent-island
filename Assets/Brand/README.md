...
- `AppIcon.appiconset/`, `AgentIsland.iconset/`, and `AgentIsland.icns` are generated packaging assets.
...
- the script outputs:
  ...
  - `AgentIsland.iconset/` and `AgentIsland.icns` for manual macOS bundle packaging
